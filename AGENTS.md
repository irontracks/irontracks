# IronTracks — Instruções para Codex
...
**REGRA FIXA do usuário: SEMPRE subir build pro App Store Connect via terminal, NUNCA abrir Xcode UI pra Archive/Distribute. Faz o Codex perder tempão.**
