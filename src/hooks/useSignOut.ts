 ...
 * @module useSignOut
 *
 * Provides a safe `signOut` callback that clears local storage,
 * invalidates the Supabase session, and optionally redirects to
 * the login page. Guards against multiple concurrent sign-out calls.
 *
