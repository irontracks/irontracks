 ...
 *
 * One-time iOS native shell initialisation. Requests push-notification
 * permissions, registers notification action handlers, and configures
 * native-specific behaviours (status bar, haptics). Only runs inside
 * the iOS WKWebView wrapper — no-ops on web.
 */
'use client'
