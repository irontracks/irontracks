...
const buildPromptSingle = (answers: any) => {
  ...
  const absoluteRules: string[] = [
    ...
    'Escreva em pt-BR.',
    'A prioridade máxima é obedecer fielmente as preferências e restrições do usuário (answers.constraints). Não ignore.',
  ...
  const prompt = [
    ...
    '',
    'CAMPO DE PREFERÊNCIAS E RESTRIÇÕES (texto original):',
    constraints,
    '',
    'CAMPO DE PREFERÊNCIAS E RESTRIÇÕES (normalizado):',
