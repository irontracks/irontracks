...
import { postWorkoutMealGenerationConfig } from '@/utils/ai/routeContracts'
...
export async function POST(req: Request) {
  try {
    ...
    const model = getGeminiModel(apiKey, MODEL_ID, postWorkoutMealGenerationConfig())
    ...
    return handleGeminiError('post-workout-meal', e)
  }
}
