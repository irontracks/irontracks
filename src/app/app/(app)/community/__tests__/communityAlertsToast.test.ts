...
describe('community — erros via toast, não window.alert', () => {
  const hook = readFileSync('src/app/app/(app)/community/useCommunityData.ts', 'utf8')
  const client = readFileSync('src/app/app/(app)/community/CommunityClient.tsx', 'utf8')
