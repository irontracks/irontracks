...
import CommunityLoading from '@/app/app/(app)/community/loading';
...
const CommunityClient = dynamic(() => import('@/app/app/(app)/community/CommunityClient'), { ssr: false, loading: () => <CommunityLoading /> });
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className="tap-44 w-9 h-9 rounded-full flex items-center justify-center text-neutral-400 active:scale-95 transition-all"
