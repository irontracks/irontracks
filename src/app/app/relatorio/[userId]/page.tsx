        ...
        <div className="inner">
          ...
          <div className="hero">
            ...
            <div className="s3">
              ...
              <a className="sc" href="https://irontracks.com.br/dashboard" target="_blank" rel="noopener">
            ...
            <div className="sec">
              ...
              {templates.length > 0 && (
                <div style={{ marginTop: '1rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 9 }}>
                  {templates.map((t) => (
                    <a key={t.id} className="dc" href="https://irontracks.com.br/dashboard" target="_blank" rel="noopener">
          ...
          <div className="ft">
            ...
            <div className="clist">
              <a className="cta" href="https://irontracks.com.br/dashboard">Abrir IronTracks</a>
