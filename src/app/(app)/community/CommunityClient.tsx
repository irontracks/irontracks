...
import { ArrowLeft, Search, Settings, UserPlus, UserMinus, Users, Check, X, Clock, Bell, Loader2 } from 'lucide-react'
      ...
      <div className={embedded ? 'space-y-3' : 'max-w-4xl mx-auto space-y-3'}>
        ...
        <GoldGradientBorder>
          <div className="p-4">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-neutral-500 mt-0.5">Siga alunos e professores para receber notificações.</div>
                </div>
              </div>
              <button
                type="button"
            ...
            {/* Search bar */}
            <div
              className="mt-4 flex items-center gap-2.5 px-4 py-3 rounded-xl transition-all"
