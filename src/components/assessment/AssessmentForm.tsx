  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 text-white">
      <div className="mb-4 sm:mb-6">
        {/* O modal do histórico já diz "Editar Avaliação" no cabeçalho, e este
            h1 logo abaixo dizia "Nova": duas afirmações contrárias sobre a mesma
            tela, a 40px uma da outra. `initialData` é justamente o que marca o
            modo de edição. */}
        <h1 className="text-2xl sm:text-3xl font-bold text-white mb-1">
          {initialData ? 'Editar Avaliação Física' : 'Nova Avaliação Física'}
        </h1>
