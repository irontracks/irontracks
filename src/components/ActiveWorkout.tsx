     ...
     <WorkoutTimerProvider startedAtMs={startedAtMs} lastActiveAtMs={lastActiveAtMs}>
      ...
      >
        ...
        {/* Consentimento do professor: NO FLUXO, entre a tira e o conteúdo.
            ...
            a tira, depois o primeiro card da lista — faixa fixa SEMPRE flutua
            sobre alguma coisa, e cada correção geométrica só mudava a vítima.
            Aqui ela EMPURRA: nada fica escondido e não há geometria a acertar. */}
        {props.controlConsent && (
          <StudentControlConsent
            teacherName={props.controlConsent.teacherName}
            onAccept={props.controlConsent.onAccept}
            onReject={props.controlConsent.onReject}
          />
        )}
