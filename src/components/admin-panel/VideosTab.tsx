                ...
                <div className="space-y-4">
                    <div className="flex gap-2">
                        <input
                            ...
                            className="flex-1 rounded-xl px-4 py-3 text-white focus:border-yellow-500 focus:outline-none"
                            style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}
                        />
                        <select
                            value={videoBackfillLimit}
                            onChange={(e) => setVideoBackfillLimit(e.target.value)}
                            className="rounded-xl px-4 py-3 text-white focus:border-yellow-500 focus:outline-none"
                            style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}
                        >
                    ...
                    <div className="mt-6 border-t border-neutral-800 pt-6">
                        ...
                        <div className="max-h-60 overflow-y-auto space-y-2 pr-2 custom-scrollbar">
                            {videoQueue.map((item: Record<string, unknown>, idx) => (
                                <div key={idx} className="flex items-center justify-between p-3 rounded-lg text-sm" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)' }}>
