                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <div className="relative flex-1 md:flex-none">
                        ...
                        <select
                            ...
                            className="w-full md:w-48 rounded-xl pl-10 pr-4 py-3 text-white appearance-none focus:border-yellow-500 focus:outline-none cursor-pointer"
                            style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}
                        >
            ...
            <div className="grid gap-3">
                {errorsLoading ? (
                    ...
                    errorReports.map((err) => (
                        <div key={err.id} className="group rounded-xl p-4 hover:border-red-500/30 transition-all" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)' }}>
