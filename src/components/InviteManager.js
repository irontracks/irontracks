                        ...
                        return (
                            <div key={user.id} className="flex items-center justify-between p-3 bg-neutral-800/50 hover:bg-neutral-800 rounded-xl transition-colors group border border-transparent hover:border-neutral-700">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-white text-sm">{user.displayName || user.email}</h4>
                                        <p className="text-[10px] text-neutral-500 font-mono">ID: {user.id.slice(0, 8)}...</p>
                                ...
                                <button
                                    onClick={() => !invited && handleInvite(user)}
                                    disabled={invited}
