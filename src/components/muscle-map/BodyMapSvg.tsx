...
const defaultOffsetsFront: ViewOffsets = {
  ...
  delts_front_l: { x: -53.5, y: -10.5, s: 1, r: 0 },
  delts_front_r: { x: 42.5, y: -10, s: 1, r: 0 },
  delts_side_l: { x: -32, y: -27, s: 1, r: -5 },
  delts_side_r: { x: 21.5, y: -23, s: 1, r: 11 },
  chest_l: { x: -25.5, y: -11.5, s: 1, r: 0 },
  chest_r: { x: 13.5, y: -11, s: 1, r: 0 },
  abs: { x: -111.5, y: -150, s: 2.05, r: 0 },
  biceps_l: { x: -37.5, y: -6, s: 1, r: 21 },
  biceps_r: { x: 28, y: -6, s: 1, r: -21 },
  quads_inner_l: { x: -3.5, y: 82.5, s: 1, r: 0 },
  quads_outer_l: { x: -47.5, y: -31, s: 1.43, r: -7 },
  quads_inner_r: { x: -2.5, y: 82.5, s: 1, r: 0 },
  quads_outer_r: { x: -49, y: -28, s: 1.43, r: 9 },
  calves_l: { x: -2.5, y: 164, s: 1, r: 0 },
  calves_r: { x: -7.5, y: 164, s: 1, r: 0 },
};

const defaultOffsetsBack: ViewOffsets = {
  global: { x: 50, y: 55, s: 0.52, r: 0 },
  upper_back: { x: 3, y: 0, s: 1, r: 0 },
  delts_rear_l: { x: -42.5, y: -47, s: 1.64, r: 0 },
  delts_rear_r: { x: -70, y: -48.5, s: 1.64, r: 0 },
  lats_l: { x: -11.5, y: 0, s: 1, r: 0 },
  lats_r: { x: 9.5, y: 0, s: 1, r: 0 },
  spinal_erectors_l: { x: 0, y: 0, s: 1, r: 0 },
  spinal_erectors_r: { x: 1.5, y: 0, s: 1, r: 0 },
  triceps_l: { x: -38.5, y: 10.5, s: 1, r: 21 },
  triceps_r: { x: 47.5, y: 8, s: 1, r: -21 },
  glutes_l: { x: 0, y: 46, s: 1, r: 0 },
  glutes_r: { x: 6, y: 46.5, s: 1, r: 0 },
  hamstrings_l: { x: -29, y: -50, s: 1.49, r: 0 },
  hamstrings_r: { x: -60, y: -53.5, s: 1.5, r: 0 },
  calves_rear_l: { x: 8, y: 159, s: 1, r: 0 },
  calves_rear_r: { x: 0, y: 160, s: 1, r: 0 },
};
