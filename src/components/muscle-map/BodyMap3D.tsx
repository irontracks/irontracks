...
export default function BodyMap3D({ muscles, selected, view, onSelect, onUnavailable }: Props) {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      viewer.style.cssText = 'display:block;width:100%;height:100%;background:#000;touch-action:none;overscroll-behavior:none'
  ...
  return <div className="flex min-h-0 flex-1 flex-col">
    <div className="relative min-h-0 flex-1 overflow-hidden rounded-2xl border border-neutral-800 bg-black" aria-busy={!ready}>
