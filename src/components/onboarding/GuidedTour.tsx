...
export default function GuidedTour({
  ...
  // intentional: `emit` and `safeSteps` are stable across renders (memoised/useCallback).
  // Including them would fire the event on every render, not just when the step changes.
