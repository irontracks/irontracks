            ...
            <div className={embedded ? 'w-full text-white' : 'min-h-screen bg-neutral-900 text-white p-4 pb-safe-extra'}>
                ...
                {!embedded && (
                    <div className="mb-5 flex items-center gap-2 sm:gap-3">
                        <button type="button" onClick={onBack} className="cursor-pointer relative z-10 tap-44 w-10 h-10 flex items-center justify-center rounded-xl bg-neutral-800 border border-neutral-700 text-neutral-200 hover:bg-neutral-700 transition-all duration-300 active:scale-95" aria-label="Voltar"><ChevronLeft className="pointer-events-none" /></button>
                        ...
                        <div className="flex items-center gap-2 justify-end shrink-0">
                            ...
                            {!isReadOnly && !isSelectionMode && (
                                <button type="button" onClick={() => setShowManual(true)} className="cursor-pointer relative z-10 tap-44 w-9 h-9 bg-yellow-500 text-black rounded-xl hover:bg-yellow-400 font-black flex items-center justify-center shadow-lg shadow-yellow-500/20 transition-all duration-300 active:scale-95" aria-label="Adicionar treino">
                                    <Plus size={16} />
                                </button>
                            )}
                        </div>
