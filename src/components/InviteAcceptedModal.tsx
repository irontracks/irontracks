...
export default function InviteAcceptedModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-md flex items-center justify-center p-6 pt-safe pb-safe animate-fade-in" role="dialog" aria-modal="true" aria-label="InviteAccepted">
