            ...
            {isOpen && (
                <>
                    ...
                    <div className="absolute right-0 top-13 w-[340px] z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                        {/* Glass panel */}
                        <div className="rounded-3xl border border-white/10 bg-neutral-950/95 backdrop-blur-xl shadow-2xl shadow-black/60 overflow-hidden">
                            ...
                            <div className="px-4 pt-4 pb-3 flex items-center justify-between border-b border-white/5">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className="w-7 h-7 rounded-xl bg-neutral-800 border border-neutral-700 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-neutral-700 transition-all active:scale-90"
                                    >
                                        <X size={13} />
                                    </button>
                                </div>
