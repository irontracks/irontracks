...
import { CardioBlocosEditor, totalMinutosDosBlocos } from './CardioBlocosEditor'
...
export const CardioFields: React.FC<CardioFieldsProps> = ({
    ...
    // BLOCOS — a mecânica e o JSX moram em `CardioBlocosEditor`, fonte única
    // compartilhada com o modal rápido do treino ativo. Aqui ficam só as duas
    // leituras que ESTA tela faz por cima deles: quantos são (o total vira
    // derivado) e a soma dos minutos.
    const blocos = setDetails.length > 0 ? setDetails : [{} as SetDetail]
    const emBlocos = blocos.length > 1
    const totalMinutos = totalMinutosDosBlocos(blocos)
        ...
        <>
            ...
            <div className="mt-4 pt-4 border-t border-white/[0.06]">
                <CardioBlocosEditor
                    ...
                    onUpdateSetsCount={(total) => onUpdateExercise('sets', String(total))}
                />
            </div>
