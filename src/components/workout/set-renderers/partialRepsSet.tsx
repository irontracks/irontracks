...
const PartialRepsSetInner = ({ ex, exIdx, setIdx }: { ex: WorkoutExercise; exIdx: number; setIdx: number }) => {
  const { getLog, updateLog, setPartialRepsModal, openNotesKeys, toggleNotes, startTimer, reportHistory , settings} = useWorkoutContext();
      ...
      >
        {done ? (
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] uppercase tracking-widest font-black text-emerald-400 shrink-0">Parciais</span>
