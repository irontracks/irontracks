  ...
  return (
    <div className={className}>
      <button
        ...
        className="inline-flex items-center gap-0.5 text-[10px] font-bold uppercase tracking-widest text-neutral-400 hover:text-neutral-300 transition-colors tap-44"
      >
        {label}
