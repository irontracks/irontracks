...
REVOKE ALL ON FUNCTION public.iron_rank_my_total_volume() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.iron_rank_my_total_volume() TO authenticated;
GRANT EXECUTE ON FUNCTION public.iron_rank_my_total_volume() TO service_role;
